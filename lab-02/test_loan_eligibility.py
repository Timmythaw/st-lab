...
class TestLoanEligibility(unittest.TestCase):
    ...
    def test_valid_applicant_employed_new(self):
        ...
        """
        self.assertTrue(is_eligible_for_loan(age=30, income=45000, credit_score=750,
        employment_status='employed', customer_type='new'))
    ...
    def test_invalid_age_below_min(self):
        ...
        """
        self.assertFalse(is_eligible_for_loan(age=17, income=45000, credit_score=750,
        employment_status='employed', customer_type='new'))
    ...
    def test_invalid_income_below_min(self):
        ...
        Expected: False (ineligible)
        """
        self.assertFalse(is_eligible_for_loan(age=30, income=25000, credit_score=750,
        employment_status='employed', customer_type='new'))
    ...
    def test_invalid_credit_score_above_max(self):
        ...
        Expected: False (ineligible)
        """
        self.assertFalse(is_eligible_for_loan(age=30, income=45000, credit_score=900,
        employment_status='employed', customer_type='new'))
    ...
    def test_invalid_employment_status_unemployed(self):
        ...
        Expected: False (ineligible)
        """
        self.assertFalse(is_eligible_for_loan(age=30, income=45000, credit_score=750,
        employment_status='unemployed', customer_type='new'))
